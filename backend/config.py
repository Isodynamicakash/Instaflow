...
class Settings(BaseSettings):
    ...
    ZERNIO_PROFILE_ID: str = os.getenv("ZERNIO_PROFILE_ID", "").strip()  # NEW — required by /v1/comment-automations
    ...
    # Dashboard
    DASHBOARD_ORIGIN: str = os.getenv("DASHBOARD_ORIGIN", "*").strip()  # NEW — lock CORS to your frontend's URL once deployed
